package com.CrafterStar.generator;
...
public class ContentCodeGenerator {
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/CrafterStar-generator/src/main/java");
		gc.setAuthor("WMING");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://192.168.101.65:3306/crafterstar_" + SERVICE_NAME
